  ...
  return (
    <div className="bg-lime-200 h-screen  ">
      <div className="container mx-auto py-3 ">
        <h1 className="text-5xl font-bold mb-[3rem] mt-[2rem] ml-20 flex justify-center hover:animate-vibrate underline underline-offset-1">Mis Proyectos</h1>
        <div className=" flex flex-nowrap  h-fit">
          {projects.map((project: IProject)=> (
            <div key={project.id} className=" rounded-lg  w-[35rem] mx-auto ">
              <div className="  group cursor-pointer w-full">
                <div className="relative transform transition ease-in-out  [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)] duration-1000 " >
                  {loading && (
                    <div className="w-full h-[500px]  flex justify-center pt-[8rem] bg-white rounded-t-[2rem] ">
                  ...
                  <img
                    ...
                    className={`w-full h-[500px]  rounded-lg rounded-t-[2rem] mb-0  ${loading ? 'hidden' : ''}`}
